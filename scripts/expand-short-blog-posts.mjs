  ...
  const sections = [
    {
      heading: headings[0],
      paragraphs: [
        buildParagraph(['context', 'practice', 'friction', 'compare', 'personal', 'example'], ctx, seed, 0),
        buildParagraph(['context', 'practice', 'friction', 'compare', 'personal', 'mistake'], ctx, seed, 1),
      ],
    },
    {
      heading: headings[1],
      paragraphs: [
        buildParagraph(['practice', 'friction', 'example', 'mistake', 'personal', 'compare'], ctx, seed, 2),
        buildParagraph(['practice', 'friction', 'example', 'mistake', 'personal', 'context'], ctx, seed, 3),
      ],
    },
    {
      heading: headings[2],
      paragraphs: [
        buildParagraph(['mistake', 'compare', 'personal', 'close', 'context', 'practice'], ctx, seed, 4),
        buildParagraph(['mistake', 'compare', 'personal', 'close', 'example', 'friction'], ctx, seed, 5),
      ],
    },
    {
      heading: headings[3],
      paragraphs: [
        buildParagraph(['close', 'compare', 'personal', 'practice', 'context', 'example'], ctx, seed, 6),
        buildParagraph(['close', 'compare', 'personal', 'friction', 'mistake', 'example'], ctx, seed, 7),
      ],
    },
  ]
...
const selected = posts.filter((post) => post.minutes <= 6)
...
console.log(`Expanded ${updated} short blog posts with additional draft material`)
