...
Optionally ask the user directly to clarify what you cannot infer. Ask whether they'd like a brief summary of PRODUCT.md appended to .rulesync/settings.json for easier agent reference. If yes, append a short **Design Context** pointer section there.
