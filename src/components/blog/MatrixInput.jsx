        ...
        <Fragment key={`row-${rowIndex}`}>
          {rowValues.map((value, columnIndex) => (
            <input
              ...
              className="rounded-md border border-gray-200 text-center text-sm text-black disabled:border-gray-400 disabled:bg-[#d0d0d0] sm:text-base dark:border-gray-200 dark:text-white disabled:dark:border-gray-600 disabled:dark:bg-[#222222]"
              value={
