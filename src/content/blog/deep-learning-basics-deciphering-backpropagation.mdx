...
image: "../../assets/backpropagation_cover.png"
...
import HocusPocus from "@assets/hocus-pocus-machine-learning.gif"
...
<div class="float-right ml-4 h-auto w-full overflow-hidden sm:w-1/2">
  <Image
    src={HocusPocus}
