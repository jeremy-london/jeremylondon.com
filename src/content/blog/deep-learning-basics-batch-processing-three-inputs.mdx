...
<PythonModule client:only filePath="examples/basics/three_input_batch_relu.py" outputRows={22} />
...
{/* LinkedIn Post: [Coding by Hand: Batch Processing Three Inputs](https://www.linkedin.com/posts/jeremyclondon) */}