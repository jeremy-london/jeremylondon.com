...
The real question is duller and harder: what was the agent allowed to touch, and how would we know if it crossed the line?

## scope should read like a contract
...
## credentials should never be vague
...
## side effects belong in separate buckets
